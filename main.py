import os
from operations.file_operations import split_file_at_marker, group_files_by_keyword
from operations.yaml_operations import parse_yaml_and_create_files, split_helm_output,find_folder_name_from_yaml_files,extract_and_save_content
from operations.cert_operations import extract_certificates_from_file, printcerts
from utils.path_utils import get_project_directories
from utils.print_utils import print_message, log_info, log_error

def main():
    try:
        # Set up directories
        input_directory, output_directory = get_project_directories()
